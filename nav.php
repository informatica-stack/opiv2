...
?>
<!-- Barra de Navegación Superior Fija SaaS (Limpia y Minimalista) -->
<nav class="navbar navbar-light bg-white border-bottom shadow-xs sticky-top py-2.5 px-3 px-md-4" style="z-index: 1030;">
    <div class="container-fluid px-0 d-flex align-items-center justify-content-between">
        
        <!-- 1. Marca y Logotipo -->
        <a class="navbar-brand d-flex align-items-center gap-2.5 m-0 text-decoration-none" href="index.php">
        ...
        <!-- 2. Acciones del Header: Botón Único de Menú + Perfil de Usuario -->
        <div class="d-flex align-items-center gap-2.5">
            
            <!-- Botón Desplegable del Menú del Sistema -->
            <button class="btn btn-outline-secondary btn-sm fw-bold d-flex align-items-center gap-2 px-3 py-2 rounded-3 text-dark border-secondary-subtle shadow-xs" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNav" aria-controls="offcanvasNav">
                <i class="bi bi-grid-fill text-primary fs-6"></i>
                <span class="fw-bold" style="font-size: 13px;">Menú del Sistema</span>
            </button>
            ...
            <div class="dropdown">
                <button class="btn p-0 border-0 d-flex align-items-center gap-2 text-start" type="button" id="dropdownUserAvatar" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="d-flex align-items-center justify-content-center text-white rounded-circle shadow-xs" style="width: 36px; height: 36px; font-weight: 800; font-size: 12.5px; background: linear-gradient(135deg, #2563eb, #06b6d4);">
    ...
    <div class="offcanvas-header border-bottom py-3 px-4 bg-light">
        <div class="d-flex align-items-center gap-2.5">
            ...
            <div>
                ...
                <span class="text-muted" style="font-size: 9px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Municipalidad de Lebu</span>
            </div>
        </div>
