                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-light mt-2 p-2" aria-labelledby="dropdownNavMenu" style="min-width: 250px;">
                    ...
                    <?php if($rol === 'PRESUPUESTO' || $rol === 'FINANZAS' || $rol === 'SYSADMIN'): ?>
                        ...
                        <?php if($rol === 'PRESUPUESTO' || $rol === 'SYSADMIN'): ?>
                            ...
                            <li><a class="dropdown-item rounded-3 py-2 small d-flex align-items-center gap-2 <?= ($pagina_actual === 'cuentas_centros_costo.php' || $pagina_actual === 'centros_de_costo.php' || $pagina_actual === 'mantenedor_cuentas.php') ? 'active bg-primary text-white' : 'text-dark' ?>" href="cuentas_centros_costo.php"><i class="bi bi-wallet2"></i> Cuentas y Centros de Costo</a></li>
                        <?php endif; ?>
