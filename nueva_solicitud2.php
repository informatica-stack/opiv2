<?php 
// nueva_solicitud2.php - Vista UI Renovada (Estilo Frontend 1: Clean SaaS Minimalist)
...
<head>
    ...
    <!-- CDNs: Fonts, Bootstrap Icons & Bootstrap 5 JS -->
...
<body>
    ...
    <header class="saas-topbar">
        ...
        <nav class="saas-nav-links d-none d-md-flex">
            <a href="mis_solicitudes2.php" class="saas-nav-item"><i class="bi bi-file-earmark-text"></i> Mis Solicitudes</a>
            <a href="nueva_solicitud2.php" class="saas-nav-item active"><i class="bi bi-plus-circle"></i> Nueva Solicitud</a>
        ...
        <div class="d-flex align-items-center gap-3">
            <div class="d-none d-sm-block text-end">
                <div style="font-weight: 700; font-size: 12px;"><?= htmlspecialchars($user_name) ?></div>
                <div style="font-size: 10.5px; color: var(--text-muted);"><?= htmlspecialchars($user_rol ?: 'Usuario') ?></div>
            </div>
            <a href="mis_solicitudes2.php" class="btn-saas btn-saas-secondary" style="padding: 6px 12px; font-size: 12px;">Volver</a>
        </div>
    </header>
    ...
    <main class="saas-container">
        ...
        <div class="page-header-row">
            <div class="page-title">
                <div class="breadcrumbs">
                    <a href="mis_solicitudes2.php">Mis Solicitudes</a>
            ...
            <div>
                <a href="mis_solicitudes2.php" class="btn-saas btn-saas-secondary">
        ...
        <div class="cc-info-card">
            ...
            <div style="background: var(--bg-body); border: 1px solid var(--border-color); padding: 8px 14px; border-radius: var(--radius-sm); font-size: 12.5px;">
                ...
                <strong style="color: var(--primary); font-family: monospace;">#<?= htmlspecialchars($centro_costo['codigo_cuenta']) ?></strong>
            </div>
        </div>

        <!-- FORMULARIO PRINCIPAL -->
        <form method="POST" action="nueva_solicitud2.php" enctype="multipart/form-data" id="formCompra" onsubmit="return procesarEnvio(event)">
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-12 col-md-5">
                                        <div class="input-group">
                                            <span class="input-group-text bg-white font-monospace fw-bold">$</span>
                                    ...
                                    <div class="col-12 col-md-7">
                                        <div class="d-flex justify-content-between p-2 bg-white rounded border small font-monospace">
                            ...
                            <div style="background: #f8fafc; border: 1px solid var(--border-color); border-radius: var(--radius-sm); padding: 16px;">
                                ...
                                <div id="provResumenDetalle" class="d-none bg-white p-3 border rounded-3 d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="text-muted font-monospace small">RUT: <span id="provResumenRut"></span></div>
                        ...
                        <div class="col-12" id="panel-licitacion" style="display: none;">
                            <div style="background: #fdfce8; border: 1px solid #fef08a; border-radius: var(--radius-sm); padding: 16px;">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <button type="button" class="btn-saas btn-saas-secondary btn-saas-sm" onclick="agregarCriterio()"><i class="bi bi-plus-lg"></i> Criterio</button>
                                </div>
                                <div id="contenedorCriterios" class="d-flex flex-column gap-2"></div>
                                <div class="text-end mt-2 small fw-bold" id="sumaCriteriosLabel">Total: 0%</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-end">
                            <div class="col-12 col-md-5">
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <strong class="font-monospace" id="lblSubtotalNeto">$ 0</strong>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="text-muted">IVA Estimado (19%):</span>
                                    <strong class="font-monospace" id="lblIvaTotal">$ 0</strong>
                                </div>
                                <div class="d-flex justify-content-between pt-2 border-top">
                                    <span class="fw-bold fs-6">Total Solicitud:</span>
                                    <strong class="font-monospace fs-5 text-primary" id="lblGranTotal">$ 0</strong>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="d-flex justify-content-end gap-3 pt-2">
                <a href="mis_solicitudes2.php" class="btn-saas btn-saas-secondary">Cancelar</a>
    ...
    <script>
        ...
        function renderProveedoresLista(data) {
            ...
            data.forEach(p => {
                ...
                div.className = 'd-flex justify-content-between align-items-center p-2.5 border-bottom bg-white hover-bg-light';
                div.style.cursor = 'pointer';
                div.innerHTML = `
                    <div>
                        <div class="fw-bold text-dark small">${escapeHtml(p.razon_social)}</div>
                        <div class="text-muted font-monospace" style="font-size: 11px;">RUT: ${escapeHtml(p.rut)}</div>
                    </div>
        ...
        function agregarItemFila(data = null) {
            ...
            tr.innerHTML = `
                ...
                <td class="text-end fw-bold font-monospace item-total-linea">$ 0</td>
        ...
        function procesarEnvio(e) {
            ...
            if (tcCodigo === 'LICITACION') {
                let suma = 0;
                document.querySelectorAll('.crit-porc-val').forEach(inp => suma += parseFloat(inp.value) || 0);
                if (suma !== 100) {
                    alert('Los criterios de evaluación deben sumar exactamente 100%. Suma actual: ' + suma + '%');
                    e.preventDefault();
                    return false;
                }
            }
