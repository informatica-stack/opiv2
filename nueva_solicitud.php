    ...
    <script>
        ...
        function actualizarEstadoBotonSubmit() {
            ...
            if (excedeCompraAgilGlobal) {
                ...
                text.innerText = '⚠️ Monto supera 100 UTM (Compra Ágil)';
                return;
            }
        ...
        function procesarEnvio(e) {
            ...
            if (excedeCompraAgilGlobal) {
                divError.innerText = 'No se puede emitir el requerimiento: El monto excede el tope legal de 100 UTM para Compra Ágil (Art. 10 bis Ley 19.886).';
                divError.classList.remove('d-none');
                alert('No es posible continuar:\n\nEl monto estimado supera el límite legal de 100 UTM para Compra Ágil.\nDebe reducir el monto o seleccionar otra modalidad (como Licitación Pública).');
                e.preventDefault();
                return false;
            }
