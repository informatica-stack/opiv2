    ...
    <div class="card shadow-lg border-0 rounded-4 overflow-hidden" style="max-width: 420px; width: 100%;">
        ...
        <div class="card-body p-4 p-sm-5 text-center">
            ...
            <div class="d-flex justify-content-center my-3">
                <!-- BOTÓN OFICIAL CLAVEÚNICA (Lineamientos Oficiales Secretaría de Gobierno Digital) -->
                <a class="btn-cu btn-m btn-color-estandar rounded-middle" href="<?= htmlspecialchars(obtener_url_claveunica()) ?>" aria-label="Iniciar sesión con ClaveÚnica">
