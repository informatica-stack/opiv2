<?php 
// mis_solicitudes2.php - Vista UI Renovada (Estilo Frontend 1: Clean SaaS Minimalist)
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* SLIDE-OVER DRAWER FOR FAST INSPECTION */
...
<body>
    ...
    <main class="saas-container">
        ...
        <div class="saas-panel">
            ...
            <form method="GET" action="mis_solicitudes2.php" id="formFiltros">
                <div class="panel-toolbar">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <?php if ($f_q || $f_tipo || $f_estado || $f_desde || $f_hasta): ?>
                            <a href="mis_solicitudes2.php" class="btn-saas btn-saas-secondary btn-saas-sm">Limpiar</a>
                        <?php endif; ?>
                                ...
                                <td style="text-align: right;">
                                    <div class="d-flex align-items-center justify-content-end gap-1.5">
                                        ...
                                        <?php if (in_array($row['estado_actual'], ['BORRADOR', 'EN_REVISION_JEFATURA', 'EN_CORRECCION'])): ?>
                                            ...
                                            <a href="mis_solicitudes2.php?anular_id=<?= $row['id'] ?>" onclick="return confirm('¿Confirma anular definitivamente esta solicitud?')" class="btn-saas btn-saas-danger btn-saas-sm" title="Anular">
                ...
                items.forEach(it => {
                    ...
                    tbody.innerHTML += `
                        <tr style="border-bottom: 1px solid var(--border-color);">
                            ...
                            <td style="padding: 8px 10px; text-align: center;">${cant} <span style="font-size: 9.5px; color: var(--text-muted);">${escapeHTML(it.unidad_medida || '')}</span></td>
